'use strict';import GameObject from"./object";import{ShapedObject2dCollider}from"./renderer_collider";import{Polygon,Vec2}from"../utils/geometry2d";import{collisionLayersFilter}from"./manager";class Bullet extends GameObject{constructor(launcher,position,speed,damage,maxRect,lifeTime=0){super(position,speed);this.damage=damage;if(lifeTime)this.lifeTime=lifeTime;this.launcher=launcher;this.maxRect=maxRect}setLauncher(object){this.launcher=object}getLauncher(){return this.launcher}setDamages(value){this.damage=
...
maxForce);class HomingBullet extends Bullet{constructor(launcher,damage,position,speed,lifeTime,steerForce,maxAngle){super(launcher,position,speed,damage,lifeTime);this.steerForce=steerForce;this.maxSpeed=speed.magnitude;this.maxAngle=maxAngle;this.angle=0;this.setAccelerationXY(0,0)}getMaxSpeed(distance){return this.maxSpeed*(1-Math.sqrt(this.maxSpeed/(150*distance)))}getSteerForce(maxSpeed,distance){return this.steerForce*(maxSpeed/Math.pow(distance,1.2))}getTargetPosition(gameManager){let res,
