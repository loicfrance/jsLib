 ...
 * @module game/object
 */
import {Vec2, Rect} from "../utils/geometry2d"
...
//**********************************************************************************************************************
	 ...
	 * -->is only called for objects with a {@link game.Object#bodyLayer|bodyLayer} greater or equal to 0.
	 * By default, this method does nothing, but you can override it when using rigidBodies to call the <!--
	 * -->{@link game.physics.RigidBody#processForces|RigidBody.processForces} method
	 * @param {game.GameManager} gameManager
	 */
	 ...
	 * the {@link game.Object#canCollideWith|canCollideWith} method and before the onCollision method, for both objects
 ...
 * -->{@link game.Object#collisionLayers|collisionLayers} array.
