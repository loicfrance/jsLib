...
import {Vec2, Rect, Circle} from "../utils/geometry2d";

import {Object2dCollider, AABBObject2dCollider, ShapedObject2dCollider} from "./renderer_collider";
...
class RigidBody {
	constructor(material = Materials.Rock) {
		...
		/**
		 * @type {Array<game.physics.Force>}
		 */
		this.frameForces = [];
		/**
		 * @type {Array<utils.geometry2d.Vec2>}
		 */
